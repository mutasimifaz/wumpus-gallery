...
const AllUser = () => {
  ...
  const {
    ...
    fetch("https://wumpusgallery.herokuapp.com/users", {
      method: "GET",
      headers: {
        ...
        <table className="table w-full dark:bg-gray-700 dark:text-white">
          <thead className="dark:bg-gray-700 dark:text-white">
            <tr>
              ...
              <th className="dark:bg-gray-700 dark:text-white">Email</th>
              <th className="dark:bg-gray-700 dark:text-white">Profile</th>
