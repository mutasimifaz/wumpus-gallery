...
"
  ...
  return (
    <div className="dark:bg-gray-700 text-white h-screen">
      <div>
          ...
          {user?.emailVerified ? (
            <div>
              <p className="mt-2 text-green-500">
                Hello, you have successfully signed up to Wumpus. Your email is
                verified.
                <br />
                {!user?.emailVerified &&
                  `If you can't find our email in inbox plz also check spam box.`}
              </p>
            ...
            <div>
              <p className="mt-2 text-green-500">
                Hello, you have successfully signed up to Wumpus. Please check
